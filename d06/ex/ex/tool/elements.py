...
class Input(Elem):
	"""docstring for ."""
	def __init__(self, content=None, attr={}):
		super().__init__(content=content, tag='input', attr=attr, tag_type='simple')

class Option(Elem):
	"""docstring for ."""
	def __init__(self, content=None, attr={}):
		super().__init__(content=content, tag='option', attr=attr, tag_type='simple')

class Form(Elem):
	"""docstring for ."""
	def __init__(self, content=None, attr={}):
		super().__init__(content=content, tag='form', attr=attr, tag_type='double')

class Select(Elem):
	"""docstring for ."""
	def __init__(self, content=None, attr={}):
		super().__init__(content=content, tag='select', attr=attr, tag_type='double')

class A(Elem):
	"""docstring for ."""
	def __init__(self, content=None, attr={}):
		super().__init__(content=content, tag='a', attr=attr, tag_type='double')

class Nav(Elem):
	"""docstring for ."""
	def __init__(self, content=None, attr={}):
		super().__init__(content=content, tag='nav', attr=attr, tag_type='double')
